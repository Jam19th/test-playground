...
describe("test for the header", () => {
  test("header appears in component with correct text", () => {
    render(<App />)
...
describe("test for the checkbox", () => {
  test("checkbox disabled button when first clicked and enables on the second click", () => {
    render(<App />)
...
describe("test for the paragraph", () => {
